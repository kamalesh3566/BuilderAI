...
export type GenerationResultData = z.infer<typeof GenerationResultSchema>;
...
export type FileOpData = z.infer<typeof FileOpSchema>;
...
export type RevisionResultData = z.infer<typeof RevisionResultSchema>;
...
export type FilePlanData = z.infer<typeof FilePlanSchema>;

export const FileCodeSchema = z.object({
  code: z.string(),
});

export type FileCodeData = z.infer<typeof FileCodeSchema>;
